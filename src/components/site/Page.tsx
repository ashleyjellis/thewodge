  ...
  return (
    <MaxWidthContainer className={cn('pt-16 lg:pt-20', className)}>
      <div className="max-w-2xl">
        ...
        <h1 className="mt-3 text-[34px] font-semibold leading-[1.1] tracking-tight sm:text-[42px]">
          {title}
        </h1>
        {intro ? (
...
export function Prose({
  ...
  return (
    <div
      className={cn(
        'max-w-2xl space-y-5 text-[16px] leading-relaxed text-foreground/85',
        '[&_h2]:mt-12 [&_h2]:text-[20px] [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-foreground',
        '[&_h3]:mt-8 [&_h3]:text-[16px] [&_h3]:font-semibold [&_h3]:text-foreground',
