/**
 * Set up the people in the household, then the real accounts that roll up
 * to pension/investments/cash. Calm, list-based, no charts; this is a
 * setup/maintenance screen. Every pot rollup elsewhere in the app is
 * computed by summing these accounts — never hand-entered separately.
 * Extracted from the Accounts tab so /app2's Accounts section can reuse it
 * unchanged.
 */
...
import { PersonCard, personFormToPayload, type PersonData } from './PersonCard'
import { UpdateSalaryModal } from './UpdateSalaryModal'
import { AccountForm, type AccountFormPayload } from './AccountForm'
